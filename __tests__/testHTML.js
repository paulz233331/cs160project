...
describe("Testing with Jest", () => {
  ...
  test("Resume field", () => {
    ...
    var expectedObjective = "Seeking a challenging position to use my software Web development and process" +
     " optimization skills.";
    var expectedSummary = "I worked on a wide range of products including building advanced dynamic multi language web sites,\n"+
    ...
    "creating high quality software.\nI'm energenic, solution oriented team-player, constantly learning and growing as a team,"+
    " and bringing high spirits\nalong with me.";
